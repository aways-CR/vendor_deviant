...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ifdef DEVIANT_RELEASE
        ...
        DEVIANT_MOD_VERSION := DeviantXone-$(PRODUCT_RELEASE_NAME)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-OFFICIAL
    else
        DEVIANT_VERSION := DeviantXone-$(PRODUCT_VERSION_MAJOR)_$(PRODUCT_VERSION_MINOR)-OFFICIAL-$(shell date)
        DEVIANT_MOD_VERSION := DeviantXone-$(PRODUCT_RELEASE_NAME)_$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-OFFICIAL-$(shell date)
    endif
