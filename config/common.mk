...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ifdef DEVIANT_RELEASE
        ...
        DEVIANT_MOD_VERSION := Deviant-$(PRODUCT_RELEASE_NAME)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-OFFICIAL
    else
        DEVIANT_VERSION := Deviant-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-OFFICIAL-$(shell date +"%Y%m%d-%H%M")
        DEVIANT_MOD_VERSION := Deviant-$(PRODUCT_RELEASE_NAME)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-OFFICIAL-$(shell date +"%Y%m%d-%H%M")
    endif
